...
namespace ISZR.Controllers
{
    public class CamerasController : Controller
    {
        ...
        public CamerasController(ISZRContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type,Sector")] Camera camera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type,Sector")] Camera camera)
        {
            if (id != camera.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ISZRContext.Camera'  is null.");
            }
            var camera = await _context.Camera.FindAsync(id);
            if (camera != null)
            {
