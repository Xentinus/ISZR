...
namespace ISZR.Migrations
{
    ...
    [Migration("20230116112449_AddedUserSelectForRequest")]
    partial class AddedUserSelectForRequest
    {
            ...
            modelBuilder.Entity("ISZR.Models.Request", b =>
                {
                    ...
                    b.Property<int?>("ReuqestForUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ISZR.Models.Request", b =>
                {
                    ...
                    b.HasOne("ISZR.Models.User", "ReuqestFor")
                        .WithMany("Requests")
                        .HasForeignKey("ReuqestForUserId");

                    b.Navigation("Class");

                    b.Navigation("ReuqestFor");
                });
