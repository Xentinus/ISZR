...
namespace ISZR.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Settings([Bind("UserId,Username,DisplayName,Rank,Genre,Email,Phone,LastLogin,LogonCount,ClassId,PositionId,IsArchived")] User user)
        {
