...
namespace ISZR.Data
{
    public class ISZRContext : DbContext
    {
        public ISZRContext (DbContextOptions<ISZRContext> options)
            : base(options)
        {
        }

        public DbSet<ISZR.Models.WindowsPermission> WindowsPermission { get; set; } = default!;
